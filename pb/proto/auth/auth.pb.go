...
const file_proto_auth_auth_proto_rawDesc = "" +
	...
	"\busername\x18\x02 \x01(\tR\busername2\x8f\x01\n" +
	"\vAuthService\x12H\n" +
	"\rValidateToken\x12\x1a.auth.ValidateTokenRequest\x1a\x1b.auth.ValidateTokenResponse\x126\n" +
	"\aGetUser\x12\x14.auth.GetUserRequest\x1a\x15.auth.GetUserResponseB\x1dZ\x1bchat-service/pb/auth;authpbb\x06proto3"
