...
func TestHubAddAndRemoveChatClient(t *testing.T) {
	...
	hub.AddChatClient(1, nil, ConnInfo{})
...
func TestHubAddAndRemoveGroupClient(t *testing.T) {
	...
	hub.AddGroupClient(2, nil, ConnInfo{})
...
// These hub tests just check room creation and cleanup for now while I learn the basics.
